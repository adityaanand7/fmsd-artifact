...
public class GJDepthFirst<R,A> implements GJVisitor<R,A> {
   ...
   public R visit(Goal n, A argu) {
      R _ret=null;
      try {
         fs = new FileWriter("AllDynamicList.txt");
         bw = new BufferedWriter(fs);
      } catch (Exception e) {e.printStackTrace();}
      n.f0.accept(this, argu);
      n.f1.accept(this, argu);
      System.out.println(code);
      System.err.println("Total Dependency: "+ total+ "\n Dynamic: "+ dyn + "\n Callback: "+ callback);
      return _ret;
   }
   ...
   public R visit(ProgramElement n, A argu) {
      ...
      if (classname.startsWith("java.") || classname.startsWith("sun.") || classname.startsWith("javax.") || classname.startsWith("com.sun.")
    	  ...
    	  if(count == 1) {
      	  ...
      	  if(count == 1) {
    	  	System.out.print("<Static,"+classname+":"+methodname+","+typetag+","+parmnumber+",<"+fieldlist+">> = ");
    	  	count++;
    	  } else {
   ...
   public R visit(LocalType n, A argu) {
      ...
      if (classname.startsWith("java.") || classname.startsWith("sun.") || classname.startsWith("javax.") || classname.startsWith("com.sun.")
        ...
        if(typetag.startsWith("callback")) {
            callback++;
            System.out.print( "<<SuperD,"+classname+":"+methodname+","+typetag+","+parmnumber+",<"+fieldlist+">>,"+dependentvalue+","+resolvedvalue+">;");
        }else{
