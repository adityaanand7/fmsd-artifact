...
public class Main {
	...
	public static Set<SootMethod> listofMethods = new HashSet<>();
	public static void main(String[] args) {
		...
		if(args[3].equals("JDK")) {
			ST s = new ST();
			PackManager.v().getPack("wjtp").add(new Transform("wjtp.sample", s));
		} else {
...
//							}
//
//							d1.p.ParmNumber = ((ConditionalValue) es).object.ref + 1;
