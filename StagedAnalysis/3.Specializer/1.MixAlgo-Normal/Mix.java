/* Generated By:JavaCC: Do not edit this line. Mix.java */
import syntaxtree.*;
import java.util.Vector;


public class Mix implements MixConstants {
  ...
  static final public Goal Goal() throws ParseException {
   ...
   Token n28;
    ...
    n28 = jj_consume_token(0);
      n28.beginColumn++; n28.endColumn++;
      n27 = JTBToolkit.makeNodeToken(n28);
     {if (true) return new Goal(n0,n2,n3,n5,n7,n9,n11,n13,n15,n17,n19,n21,n22,n24,n25,n27);}
  ...
  static final public Statement Statement() throws ParseException {
   ...
   DeclaredAssignmentStatement n3;
   IfStatement n4;
   WhileStatement n5;
   PrintStatement n6;
   ForStatement n7;
   MessageSendStmt n8;
    ...
    default:
      ...
      if (jj_2_1(20)) {
        ...
        n3 = DeclaredAssignmentStatement();
  ...
  static final public DeclaredAssignmentStatement DeclaredAssignmentStatement() throws ParseException {
   Type n0;
   Identifier n1;
   NodeToken n2;
   Token n3;
   ...
   Token n6;
    ...
    n6 = jj_consume_token(SEMICOLON);
            n5 = JTBToolkit.makeNodeToken(n6);
     {if (true) return new DeclaredAssignmentStatement(n0,n1,n2,n4,n5);}
    throw new Error("Missing return statement in function");
  }

  static final public IfStatement IfStatement() throws ParseException {
   NodeChoice n0;
   IfthenElseifStatement n1;
   IfthenelseStatement n2;
   IfthenStatement n3;
    if (jj_2_3(40)) {
      n1 = IfthenElseifStatement();
        n0 = new NodeChoice(n1, 0);
    } else if (jj_2_4(40)) {
  ...
  static final public IfthenElseifStatement IfthenElseifStatement() throws ParseException {
   NodeToken n0;
   Token n1;
   NodeToken n2;
   Token n3;
   ...
   Statement n20;
    ...
    while (true) {
     ...
     n8.nodes.trimToSize();
    n19 = jj_consume_token(ELSE);
                n18 = JTBToolkit.makeNodeToken(n19);
    n20 = Statement();
     {if (true) return new IfthenElseifStatement(n0,n2,n4,n5,n7,n8,n18,n20);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public ForStatement ForStatement() throws ParseException {
   ...
   Statement n20;
    ...
    n19 = jj_consume_token(RPAREN);
             n18 = JTBToolkit.makeNodeToken(n19);
    n20 = Statement();
     {if (true) return new ForStatement(n0,n2,n4,n5,n6,n8,n9,n11,n12,n18,n20);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public MessageSendStmt MessageSendStmt() throws ParseException {
   MessageSend n0;
   NodeToken n1;
   Token n2;
    n0 = MessageSend();
    n2 = jj_consume_token(SEMICOLON);
            n1 = JTBToolkit.makeNodeToken(n2);
     {if (true) return new MessageSendStmt(n0,n1);}
    throw new Error("Missing return statement in function");
  }
  ...
  static final public StringLiteral StringLiteral() throws ParseException {
   NodeToken n0;
   Token n1;
    n1 = jj_consume_token(STRINGLITERAL);
                        n0 = JTBToolkit.makeNodeToken(n1);
  ...
  static public MixTokenManager token_source;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x2000,0x4000200,0xc002200,0x0,0x200,0x8000000,0x4000200,0x4000200,0x0,0x0,0x4000200,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x26708f,0x26789f,0x400000,0x0,0x40810,0x263081,0x263081,0x2000000,0x263001,0x80,0x2000000,};
   }
  ...
  public Mix(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public Mix(java.io.InputStream stream, String encoding) {
    ...
    token_source = new MixTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public Mix(java.io.Reader stream) {
    if (jj_initialized_once) {
      System.out.println("ERROR: Second call to constructor of static parser. ");
      System.out.println("       You must either use ReInit() or set the JavaCC option STATIC to false");
      System.out.println("       during parser generation.");
  ...
  /** Reinitialise. */
  public void ReInit(MixTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
