...
public class GJDepthFirst<R,A> implements GJVisitor<R,A> {
   ...
   public R visit(ProgramElement n, A argu) {
      ...
      if (classname.startsWith("java.") || classname.startsWith("sun.") || classname.startsWith("javax.") || classname.startsWith("com.sun.")
   	...
   	if(count == 1) {
   		code += "<Dynamic,"+classname+":"+methodname+","+typetag+","+parmnumber+",<"+fieldlist+">> = ";
   		count++;
   	} else {
 	...
 	if(count == 1) {
   		code += "<Static,"+classname+":"+methodname+","+typetag+","+parmnumber+",<"+fieldlist+">> = ";
   		count++;
   	}else {
   ...
   public R visit(LocalType n, A argu) {
      ...
      if (classname.startsWith("java.") || classname.startsWith("sun.") || classname.startsWith("javax.") || classname.startsWith("com.sun.")
    		  || classname.startsWith("org.omg.") || classname.startsWith("org.xml.") || classname.startsWith("org.w3c.dom")) {
    	  code += "<<Dynamic,"+classname+":"+methodname+","+typetag+","+parmnumber+",<"+fieldlist+">>,"+dependentvalue+","+resolvedvalue+">;";
      } else {
    	  code += "<<Static,"+classname+":"+methodname+","+typetag+","+parmnumber+",<"+fieldlist+">>,"+dependentvalue+","+resolvedvalue+">;";
      }
      return _ret;
   }
